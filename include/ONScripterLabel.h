...
#ifdef __SWITCH__
    void fingerPressEvent( SDL_TouchFingerEvent *event );
    void fingerMoveEvent( SDL_TouchFingerEvent *event );
#endif
#ifdef SDL2
...
#ifdef SDL2
    void fastFlushDirect( SDL_Rect rects[], int num, int refresh_mode );
#endif
    void executeLabel();
